...
namespace GameData
{
    public class GameData_Stat : GameDataBase_Stat
    {
    ...
    public class GameDataTable_Stat : GameDataTableBase_Stat
    {
        protected override bool OnAddData(GameData_Stat data)
        {
