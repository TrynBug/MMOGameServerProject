...
namespace GameData
{
    public class GameData_Item : GameDataBase_Item
    {
    ...
    public class GameDataTable_Item : GameDataTableBase_Item
    {
        protected override bool OnAddData(GameData_Item data)
        {
