...
namespace GameData
{
    public class GameData_Buff : GameDataBase_Buff
    {
    ...
    public class GameDataTable_Buff : GameDataTableBase_Buff
    {
        protected override bool OnAddData(GameData_Buff data)
        {
