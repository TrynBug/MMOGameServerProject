...
namespace GameData
{
    public class GameData_MonsterAI : GameDataBase_MonsterAI
    {
    ...
    public class GameDataTable_MonsterAI : GameDataTableBase_MonsterAI
    {
        protected override bool OnAddData(GameData_MonsterAI data)
        {
