...
namespace GameData
{
    public class GameData_ItemDrop : GameDataBase_ItemDrop
    {
    ...
    public class GameDataTable_ItemDrop : GameDataTableBase_ItemDrop
    {
        protected override bool OnAddData(GameData_ItemDrop data)
        {
