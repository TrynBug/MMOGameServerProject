...
namespace GameData
{
    public class GameData_Skill : GameDataBase_Skill
    {
    ...
    public class GameDataTable_Skill : GameDataTableBase_Skill
    {
        protected override bool OnAddData(GameData_Skill data)
        {
