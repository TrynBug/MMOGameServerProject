...
namespace GameData
{
    public class GameData_SpawnGroup : GameDataBase_SpawnGroup
    {
    ...
    public class GameDataTable_SpawnGroup : GameDataTableBase_SpawnGroup
    {
        protected override bool OnAddData(GameData_SpawnGroup data)
        {
