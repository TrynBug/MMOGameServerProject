...
namespace GameData
{
    public class GameData_Spawner : GameDataBase_Spawner
    {
    ...
    public class GameDataTable_Spawner : GameDataTableBase_Spawner
    {
        protected override bool OnAddData(GameData_Spawner data)
        {
