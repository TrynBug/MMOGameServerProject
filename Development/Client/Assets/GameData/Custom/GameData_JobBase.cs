...
namespace GameData
{
    public class GameData_JobBase : GameDataBase_JobBase
    {
    ...
    public class GameDataTable_JobBase : GameDataTableBase_JobBase
    {
        protected override bool OnAddData(GameData_JobBase data)
        {
