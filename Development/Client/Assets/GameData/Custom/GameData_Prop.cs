...
namespace GameData
{
    public class GameData_Prop : GameDataBase_Prop
    {
    ...
    public class GameDataTable_Prop : GameDataTableBase_Prop
    {
        protected override bool OnAddData(GameData_Prop data)
        {
