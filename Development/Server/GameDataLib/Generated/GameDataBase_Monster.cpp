...
bool GameDataTableBase_Monster::makeGameData(const std::string& line)
{
    ...
    std::getline(ss, field, ','); pData->SkillKey3 = std::stoi(field);
    std::getline(ss, field, ','); pData->SkillKey4 = std::stoi(field);
    std::getline(ss, field, ','); pData->SkillKey5 = std::stoi(field);
