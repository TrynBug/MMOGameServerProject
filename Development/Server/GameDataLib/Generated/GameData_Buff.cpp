...
bool GameDataTable_Buff::OnAddData(const GameData* pRawData)
{
    const GameData_Buff* pData = static_cast<const GameData_Buff*>(pRawData);
...
bool GameDataTable_Buff::OnLoadComplete()
{
