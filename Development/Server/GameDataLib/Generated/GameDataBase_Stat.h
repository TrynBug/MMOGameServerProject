...
public:
    static const GameData_Stat* FindData(int64_t key);
    static const std::map<int64_t, const GameData_Stat*>& GetDataMap() { return sm_dataMap; }
...
protected:
    inline static std::map<int64_t, const GameData_Stat*> sm_dataMap;
};
