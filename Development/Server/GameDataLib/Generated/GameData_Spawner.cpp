...
bool GameData_Spawner::Initialize()
{
    // 데이터 1건을 읽은 직후 호출됨
...
bool GameDataTable_Spawner::OnAddData(const GameData* pRawData)
{
    const GameData_Spawner* pData = static_cast<const GameData_Spawner*>(pRawData);
...
bool GameDataTable_Spawner::OnLoadComplete()
{
