...
bool GameData_Monster::Initialize()
{
    // 데이터 1건을 읽은 직후 호출됨
...
bool GameDataTable_Monster::OnAddData(const GameData* pRawData)
{
    const GameData_Monster* pData = static_cast<const GameData_Monster*>(pRawData);
...
bool GameDataTable_Monster::OnLoadComplete()
{
