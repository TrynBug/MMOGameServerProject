...
bool GameData_Skill::Initialize()
{
    // 데이터 1건을 읽은 직후 호출됨
...
bool GameDataTable_Skill::OnAddData(const GameData* pRawData)
{
    const GameData_Skill* pData = static_cast<const GameData_Skill*>(pRawData);
...
bool GameDataTable_Skill::OnLoadComplete()
{
