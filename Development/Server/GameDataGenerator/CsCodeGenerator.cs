...
namespace GameDataGenerator
{
    public class CsCodeGenerator
    {
        ...
        private static string BuildBaseFile(string tableName, List<ColumnInfo> columns)
        {
            ...
            sb.AppendLine("    {");
            sb.AppendLine($"        protected static Dictionary<int, GameData_{tableName}> sm_dataMap = new();");
            sb.AppendLine();
            sb.AppendLine($"        public override string GetDataName() => \"{tableName}\";");
            sb.AppendLine();
            sb.AppendLine($"        public static GameData_{tableName} FindData(int key)");
            sb.AppendLine("        {");
            sb.AppendLine("            sm_dataMap.TryGetValue(key, out var data);");
            sb.AppendLine("            return data;");
            sb.AppendLine("        }");
            sb.AppendLine();
            sb.AppendLine($"        public static IReadOnlyDictionary<int, GameData_{tableName}> GetDataMap() => sm_dataMap;");
            sb.AppendLine();
