...
public:
    ...
    void TryCast(int32 skillKey, const Vector3& origin, const Vector3& dir, const Vector3& targetPos, uint32 seed);
...
private:
    ...
    int32 m_pendingSkillKey = 0;   // 다음에 발동할 페이즈 스킬 Key (0 = 더 없음)
