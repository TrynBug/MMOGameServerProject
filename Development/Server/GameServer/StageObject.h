...
public:
    ...
    int32       GetCurSectorY() const { return m_curSectorY; }
    ...
    void        SetCurSector(int32 sectorX, int32 sectorY)
    {
        m_curSectorX = sectorX;
        m_curSectorY = sectorY;
    }
